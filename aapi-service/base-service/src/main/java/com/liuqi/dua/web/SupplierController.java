...
public class SupplierController {
    ...
    public void add(@RequestBody @Validated SupplierAddReq req) {
    ...
    public void update(@RequestBody @Validated SupplierUpdateReq req) {
        SupplierDTO dto = new SupplierDTO();
        BeanUtils.copyProperties(req, dto);
        service.update(dto);
    ...
    public SupplierDTO findById(@PathVariable("id") String id) {
