...
public class ApiTypeController {
    ...
    public Mono<Void> add(@RequestBody @Validated ApiTypeAddReq req) {
    ...
    public Mono<Void> update(@RequestBody @Validated ApiTypeUpdateReq req) {
        ApiTypeDTO dto = new ApiTypeDTO();
        BeanUtils.copyProperties(req, dto);
        service.update(dto);
        return Mono.empty();
    ...
    public Mono<ApiTypeDTO> findById(@PathVariable("id") String id) {
