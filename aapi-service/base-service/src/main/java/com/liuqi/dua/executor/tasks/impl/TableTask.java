...
import com.liuqi.dua.executor.bean.config.TableNodeConfig;
...
public class TableTask extends AbstractDagTask<TableNodeConfig> {
    public TableTask(NodeInput task) {
        super(task);
    }
    ...
    public Object execute() {
        ...
        try {
            String key = "dagTableTask-" + this.getId().getContext().getApiInfo().getId()
