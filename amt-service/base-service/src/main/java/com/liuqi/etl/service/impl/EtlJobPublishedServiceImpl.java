 ...
 **/
@Service
public class EtlJobPublishedServiceImpl extends AbstractBaseService<EtlJobPublishedEntity, EtlJobPublishedDTO, EtlJobPublishedMapper, EtlJobPublishedQuery> implements EtlJobPublishedService {
    @Override
