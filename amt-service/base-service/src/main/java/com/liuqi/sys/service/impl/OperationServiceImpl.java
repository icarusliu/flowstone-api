...
@Service
public class OperationServiceImpl extends AbstractBaseEntityService<OperationEntity, OperationDTO, OperationMapper, OperationQuery> implements OperationService {
    @Override
