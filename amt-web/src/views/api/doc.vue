        ...
        <el-descriptions border :column="2" class="mb-8 mt-4">
            ...
            <el-descriptions-item label="输入参数" :span="2">
                ...
                <div class="p-4" v-else>
                    <base-table :dataSupplier="() => apiConfig.inputParams" :fields="inputFields" :pageable="false"> </base-table>
                </div>
            ...
            <el-descriptions-item label="输出参数" :span="2">
                ...
                <div class="p-4" v-else>
                    <base-table :dataSupplier="() => apiConfig.output" :fields="outputFields" :pageable="false"> </base-table>
                </div>
            </el-descriptions-item>
