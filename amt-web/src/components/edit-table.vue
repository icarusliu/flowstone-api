<template>
    ...
    <el-table :data="data" class="table" :row-key="rowKey" default-expand-all border>
        <el-table-column v-for="field in fields" :key="field.prop" :label="field.label" :width="field.width"
            :align="field.align" headerAlign="left">
...
const props = defineProps(["fields", "defRow", "readonly", "showNew", "operationWidth", "rowKey", "showOperations"])
